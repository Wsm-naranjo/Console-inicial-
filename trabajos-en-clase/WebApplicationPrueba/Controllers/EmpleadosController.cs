...
namespace WebApplicationPrueba.Controllers
{
    ...
    public class EmpleadosController : Controller
    {
        ...
        // GET: Empleados
        // este metodo se esjecuta con el metodo get
        [HttpGet]
        [AllowAnonymous]        
        ...
        public async Task<IActionResult> Create([Bind("EmpleadoId,Cedula,Titulo,Nombre,Apellido,Salario,Nacimiento,DepartamentoId")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
                ...
                _context.Empleados
                    ...
                    .First(e => e.EmpleadoId == empleado.EmpleadoId);
                //Carga explicita de datos
                //Explicit load

                //empleado.Departamento <= vacio
                _context.Entry(empleado).Reference(e => e.Departamento).Load();
                //empleado.Departamento <= lleno

                //empleado.Cursos <= vacio
                _context.Entry(empleado).Collection(e => e.Cursos).Load();
                //empleado.Cursos <= LLeno
            }
            return View(empleado);
        }
